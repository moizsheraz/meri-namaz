...
import { Bell, Book, Compass, Heart, MessageCircle, Moon ,LogOut} from 'lucide-react';
    ...
    <>
      <div className="min-h-screen bg-purple-50 text-purple-900 p-4">
        ...
        <Card className="mb-6 bg-white">
          <CardHeader>
            <CardTitle>Assalamu Alaikum, {session.user.name}</CardTitle>
            ...
            <div className="grid grid-cols-7 gap-2">
              {daysOfWeek.map((day, index) => (
                <div key={day} className="text-center">
                  ...
                  <div
                    className={`w-8 h-8 rounded-full mx-auto ${index < 5 ? 'bg-purple-600' : 'bg-purple-200'}`}></div>
                </div>
              ))}
            </div>
          </CardContent>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className='bg-white'>
            ...
            <CardContent>
              <div className="text-2xl font-bold">278&deg;</div>
